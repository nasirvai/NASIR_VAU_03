...
\033[1;32
 '                                   '‚                          '‚              '‚                      ‘                                                          '‚                               '‚         
  ...
  /       /'/       /;;'/  |      '| |        /;;|‘  |'|¯¯¯¯|\¯¯¯¯\ ''|        '|;|    \/       /|;|       |;|‘              '\;;'\       \;\       \    |      '| |        /;;|‘     '/      '/;/       '/;;/‘ 
'/       /'/       /;;'/'   |       \|       '|;;'/   \|       |;|       |'‚'|\        \| '‚ '/       /;'|\|____|/'                 '\;;\       \;\       \ ' |       \|       '|;;'/     /       '|/        /;;/   
|____|;|____|;;/     |\____/\____\/'     |____|/____/| '|;\_____\'‚ |____|;'/‘                              \;;\____\|____'|  |\____/\____\/'     '|_____/|____|;'/  '‚ 
|       |/|       |/       |;|      |;|       '|      |      '||       |;|  \;|         |‘ |       |/    '‚                            '\;'|       ||       |  |;|      |;|       '|      '|        |;|       |/‘     
|____| |____|        '\|___,|/|____'|      |___,||____|/    \|_____|  |____|            '‚                       \|____||____|  '\|___,|/|____'|      '|____,|/|____|‘      
..:::::..::..:::::..:::......::: 
\033[1;37m================= \33[32;45mIRTAZA\33[0;m =====================
\033[1;32m     \033[1;32mCREATED BY\33[0;m   :  \033[1;32mIRTAZA\33[0;m\033[1;32m && \033[1;32mMOSHIN\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;32m MUHAMMAD MOSHIN
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("https://www.facebook.com/profile.php?id=100000667511510")
		exit()
...
def setting():
	...
	if baloch in ['1','01']:
		...
		method.append('api')
	print("""%s \x1b[92;1m===================================>\x1b[92;1m """%(h))
	fast = input(x+'\33[1;96m Want To Start ? (y/n) : ')
	if fast in ['y','Y']:
		passwrd()
	elif fast in ['t','T']:
		os.system("xdg-open https://facebook.com/groups/1157490851802798/")
		exit()
